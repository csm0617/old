...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public MyPanel() {//构造器，初始化画板，比如坦克
        ...
        //初始化图片
        image1 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/img1_.jpg"));
        image2 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/img2_.jpg"));
        image3 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/img3_.jpg"));
        image4 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/img4_.gif"));
        image5 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/img5_.jpg"));
    }
...
//            System.out.println("我方子弹被绘制....");
        ...
        for (int i = 0; i < bombs.size(); i++) {
            ...
            if (bomb.life > 70) {
                g.drawImage(image1, 300, 100, 300, 400, this);
            } else if (bomb.life > 60) {
                g.drawImage(image2, 300, 100, 300, 400, this);
            } else if (bomb.life>50){
                g.drawImage(image3, 300, 100, 300, 400, this);
            }else if (bomb.life>40){
                g.drawImage(image4, 300, 100, 300, 400, this);
            }else {
                g.drawImage(image5, 300, 100, 300, 400, this);
            }
            //让炸弹的生命值减少
            bomb.lifeDown();
